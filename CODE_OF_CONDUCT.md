...
- O uso de linguagem ou imagens inapropriadas de qualquer tipo
...
Instâncias de comportamento abusivo, assediador ou de outra forma inaceitável podem ser reportadas aos líderes da comunidade responsáveis pela aplicação em **missionapp.faithtech@gmail.com**. Todas as reclamações serão analisadas e investigadas de forma rápida e justa.
...
**Consequência:** Um aviso escrito e privado dos líderes da comunidade, fornecendo clareza sobre a natureza da violação e uma explicação do porquê o comportamento foi inadequado. Um pedido de desculpas público pode ser solicitado.
...
**Impacto na Comunidade:** Demonstrar um padrão de violação dos padrões da comunidade, incluindo comportamento inadequado sustentado, assédio a um indivíduo ou agressão ou menosprezo de classes de indivíduos.
