...
- [ADR-0017](./0017-adocao-de-uuid-v7-como-estrategia-de-chave-primaria.md): UUID v7 como chave primária, implementado via mixin `WithPrimaryUuid`
- [ADR-0016](./0016-convencoes-de-escrita-de-migracoes.md): convenções de migrações, complementares às convenções de modelo definidas aqui
