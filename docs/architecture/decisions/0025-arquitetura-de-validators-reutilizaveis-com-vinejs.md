# [ADR-0025]: Arquitetura de Validators Reutilizáveis com VineJS
...
- **Validators inline nos controllers:** Elimina a necessidade de arquivos separados de validator, mas acopla a lógica de validação ao controller (violando ADR-0022) e impede o reaproveitamento de schemas entre endpoints.
...
- [ADR-0022](./0022-convencoes-de-controllers-e-roteamento-rest.md): controllers sempre delegam validação a validators — nunca inline
