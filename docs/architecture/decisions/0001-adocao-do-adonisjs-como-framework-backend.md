...
- **@adonisjs/bouncer** — autorização baseada em abilities e policies, com integração nativa ao IoC container
- **@adonisjs/mail** — envio de email com suporte a múltiplos transports (SMTP, Resend, SES, etc.)
- **Japa** — framework de testes nativo, incluso no scaffold: runner, assertions e cliente HTTP de testes
- **Tuyau** — geração automática do barrel tipado de controllers (`#generated/controllers`) e cliente HTTP type-safe para consumidores do frontend
...
- [Documentação oficial do AdonisJS v7](https://docs.adonisjs.com/): referência principal do framework adotado
- [Lucid ORM](https://lucid.adonisjs.com/): documentação do ORM integrado ao AdonisJS
- [VineJS](https://vinejs.dev/): documentação do validador de schemas integrado ao AdonisJS
- [Japa](https://japa.dev/docs): framework de testes nativo do AdonisJS, incluso no scaffold api-only
...
- [ADR-0009](./0009-padronizacao-de-nomenclatura-de-buckets.md): convenção de nomenclatura de buckets S3 definida neste projeto
