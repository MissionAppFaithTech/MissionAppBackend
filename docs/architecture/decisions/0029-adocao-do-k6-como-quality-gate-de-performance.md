# [ADR-0029]: Adoção do k6 como Ferramenta de Load Testing e Quality Gate de Performance
...
- [ADR-0005](./0005-adocao-do-fallow-para-analise-estatica-de-codigo-morto.md): fallow para análise estática — contexto do princípio de evitar vendor lock-in aplicado também aqui
