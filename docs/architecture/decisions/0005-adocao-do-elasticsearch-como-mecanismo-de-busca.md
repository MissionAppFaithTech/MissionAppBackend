...
A pergunta central é: **qual mecanismo de busca atende ao requisito de busca tolerante a erros de digitação (NF.4), com suporte ao idioma Português, sem sobrecarregar o banco de dados transacional?**
