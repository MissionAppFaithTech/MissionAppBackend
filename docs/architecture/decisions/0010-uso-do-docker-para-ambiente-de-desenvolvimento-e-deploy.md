# [ADR-0010]: Uso do Docker para Padronização de Ambiente de Desenvolvimento e Deploy
...
A questão central é: **como garantir que todos os contribuidores e ambientes de CI/CD partilhem exatamente o mesmo stack de serviços, versões e configurações, sem depender do sistema operacional do host?**
...
- [Documentação oficial do Docker](https://docs.docker.com/): referência principal do runtime de containers adotado
- [Documentação do Docker Compose](https://docs.docker.com/compose/): ferramenta de orquestração local usada para subir o ambiente de desenvolvimento
- [ADR-0007](./0007-adocao-do-dragonfly-como-cache-e-armazenamento-temporario.md): DragonflyDB como cache e broker, um dos serviços orquestrados pelo Docker Compose
- [ADR-0008](./0008-uso-do-minio-como-emulador-de-storage-em-desenvolvimento.md): MinIO como emulador de storage, um dos serviços orquestrados pelo Docker Compose
- [ADR-0009](./0009-adocao-do-elasticsearch-como-mecanismo-de-busca.md): Elasticsearch como mecanismo de busca, um dos serviços orquestrados pelo Docker Compose
