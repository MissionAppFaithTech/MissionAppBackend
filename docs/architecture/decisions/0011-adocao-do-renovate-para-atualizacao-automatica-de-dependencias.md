...
- [ADR-0006](./0006-uso-do-docker-para-ambiente-de-desenvolvimento-e-deploy.md): Docker como ambiente de desenvolvimento, cujas imagens também são gerenciadas pelo Renovate
- [ADR-0007](./0007-adocao-do-pnpm-como-gerenciador-de-pacotes.md): pnpm como gerenciador de pacotes cujas dependências são atualizadas pelo Renovate
