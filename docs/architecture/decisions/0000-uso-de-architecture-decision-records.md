...
A questão central é: **como garantir que as decisões arquiteturais significativas do MissionApp Backend sejam documentadas de forma consistente, rastreável e acessível a qualquer colaborador, presente ou futuro?**
...
- [Documenting Architecture Decisions (Michael Nygard, 2011)](https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions): post original que define o formato ADR e suas seções canônicas
- [ADR GitHub Organization](https://adr.github.io/): exemplos e ferramentas da comunidade para gestão de ADRs
- [Guia completo sobre ADR](https://medium.com/@jhonywalkeer/guia-completo-sobre-architecture-decision-records-adr-defini%C3%A7%C3%A3o-e-melhores-pr%C3%A1ticas-f63e66d33e6): definição e melhores práticas em português
- [Template oficial deste projeto](../templates/adr-template.md): modelo base para criação de novos ADRs
