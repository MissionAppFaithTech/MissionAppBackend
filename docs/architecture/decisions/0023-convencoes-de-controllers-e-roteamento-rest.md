# [ADR-0023]: Convenções de Controllers e Roteamento REST
...
- [ADR-0022](./0022-convencao-de-documentacao-de-codigo-com-jsdoc.md): convenção de documentação — controllers são camada sem JSDoc por serem intencionalmente finos
