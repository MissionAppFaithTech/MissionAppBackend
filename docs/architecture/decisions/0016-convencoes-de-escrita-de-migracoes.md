...
- [ADR-0002](./0002-adocao-do-postgresql-como-banco-de-dados.md): PostgreSQL como banco alvo das migrações cujas convenções são definidas aqui
- [ADR-0007](./0007-adocao-do-pnpm-como-gerenciador-de-pacotes.md): pnpm como gerenciador de pacotes, mencionado na convenção de comandos de migração
