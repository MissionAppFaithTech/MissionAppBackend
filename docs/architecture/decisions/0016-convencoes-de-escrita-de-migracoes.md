...
A pergunta central é: **como garantir que todas as migrações do projeto sigam uma estrutura previsível, sejam autodocumentadas no nível do banco de dados e apliquem tipos corretos para referências a recursos externos?**
