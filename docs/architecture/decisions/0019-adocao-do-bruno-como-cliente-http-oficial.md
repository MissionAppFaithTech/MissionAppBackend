# [ADR-0019]: Adoção do Bruno como Cliente HTTP Oficial do Repositório
...
- [ADR-0010](./0010-uso-do-docker-para-ambiente-de-desenvolvimento-e-deploy.md): Docker que define o ambiente de desenvolvimento onde as coleções Bruno são usadas
