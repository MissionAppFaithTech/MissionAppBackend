# [ADR-0016]: Adoção do Snyk para Detecção e Correção de Vulnerabilidades
...
**Complementaridade com o Renovate ([ADR-0015](./0015-adocao-do-renovate-para-atualizacao-automatica-de-dependencias.md)):**
...
- [ADR-0015](./0015-adocao-do-renovate-para-atualizacao-automatica-de-dependencias.md): Renovate para atualização de dependências, complementar ao Snyk na gestão de segurança
- [ADR-0011](./0011-adocao-do-pnpm-como-gerenciador-de-pacotes.md): pnpm como gerenciador cujo lockfile é base do scanning do Snyk
