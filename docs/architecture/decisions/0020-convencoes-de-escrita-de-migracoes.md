# [ADR-0020]: Convenções de Escrita de Migrações de Banco de Dados
...
- [ADR-0006](./0006-adocao-do-postgresql-como-banco-de-dados.md): PostgreSQL como banco alvo das migrações cujas convenções são definidas aqui
- [ADR-0011](./0011-adocao-do-pnpm-como-gerenciador-de-pacotes.md): pnpm como gerenciador de pacotes, mencionado na convenção de comandos de migração
