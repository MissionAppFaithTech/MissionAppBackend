...
A pergunta central é: **como estruturar o empacotamento e a escrita dos Workers de forma que reutilize o máximo da infraestrutura Docker existente, garanta acesso completo ao ciclo de vida do AdonisJS e imponha uma convenção única para todos os contribuidores?**
