# [ADR-0007]: Adoção do Elasticsearch como Mecanismo de Busca
...
- [ADR-0004](./0004-adocao-do-postgresql-como-banco-de-dados.md): adoção do PostgreSQL, banco principal cujos dados serão indexados no Elasticsearch
