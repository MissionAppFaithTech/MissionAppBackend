# [ADR-0007]: Adoção do DragonflyDB como Cache, Armazenamento Temporário e Broker de Filas
...
A questão central é: **qual solução de armazenamento em memória atende simultaneamente aos requisitos de cache de alta frequência, rate limiting e broker de filas do MissionApp, sem adicionar múltiplos serviços ao stack?**
...
- [Documentação oficial do DragonflyDB](https://www.dragonflydb.io/docs): referência principal do cache/broker adotado
- [Compatibilidade DragonflyDB com clientes Redis](https://www.dragonflydb.io/docs/getting-started/redis-compatibility): justifica o uso de clientes Redis existentes sem alteração de código
- [BullMQ](https://docs.bullmq.io/): filas e workers sobre Redis/DragonflyDB usados neste projeto
- [NF.2.4 — Requisito de caching em memória](../../../Lista%20de%20Requisitos%20Mission%20App.pdf): requisito não-funcional que originou esta decisão
- [ADR-0006](./0006-adocao-do-postgresql-como-banco-de-dados.md): adoção do PostgreSQL, contexto da stack de persistência
