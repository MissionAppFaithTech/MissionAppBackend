...
A pergunta central é: **como cobrir proativamente as quatro superfícies de ataque do stack do MissionApp ao longo de todo o ciclo de vida do desenvolvimento — do commit local ao container em produção — de forma integrada ao fluxo de PR e sem custo para um projeto open-source?**
