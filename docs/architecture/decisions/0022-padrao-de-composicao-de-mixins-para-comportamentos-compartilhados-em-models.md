# [ADR-0022]: Padrão de Composição de Mixins para Comportamentos Compartilhados em Models
...
- [ADR-0021](./0021-adocao-de-uuid-v7-como-estrategia-de-chave-primaria.md): UUID v7 como chave primária, implementado via mixin `WithPrimaryUuid`
- [ADR-0020](./0020-convencoes-de-escrita-de-migracoes.md): convenções de migrações, complementares às convenções de modelo definidas aqui
