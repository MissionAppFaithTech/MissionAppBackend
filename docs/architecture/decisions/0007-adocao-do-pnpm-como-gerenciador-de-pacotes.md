# [ADR-0007]: Adoção do pnpm como Gerenciador de Pacotes
...
A pergunta central é: **qual gerenciador de pacotes oferece a melhor combinação de integridade de dependências, reprodutibilidade de ambiente e desempenho para o MissionApp Backend?**
...
* [Documentação oficial do pnpm](https://pnpm.io/motivation)
* [pnpm — Store global e hard links](https://pnpm.io/symlinked-node-modules-structure)
* [Corepack — Node.js package manager enforcement](https://nodejs.org/api/corepack.html)
