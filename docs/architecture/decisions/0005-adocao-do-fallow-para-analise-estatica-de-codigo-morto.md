# [ADR-0005]: Adoção do Fallow para Análise Estática de Código Morto
...
- [ADR-0022](./0022-padrao-de-composicao-de-mixins-para-comportamentos-compartilhados-em-models.md): padrão de mixins no Lucid — contexto para a supressão de `circular-dependencies` em `app/models/**`
- [ADR-0023](./0023-estrategia-de-autenticacao-jwt-hibrido-com-revogacao-via-dragonflydb.md): guard JWT implementado em `app/auth/guards/jwt.ts` — contexto para a supressão de `unused-class-members` em `app/auth/**`
