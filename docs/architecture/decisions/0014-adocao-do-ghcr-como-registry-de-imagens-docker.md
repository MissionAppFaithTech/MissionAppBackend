...
A pergunta central é: **qual registry de containers oferece autenticação sem gestão manual de credenciais, rastreabilidade nativa entre imagem e commit, e integração direta com o repositório GitHub onde o projeto já vive?**
