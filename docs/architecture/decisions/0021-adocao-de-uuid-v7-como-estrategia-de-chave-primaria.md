# [ADR-0021]: Adoção de UUID v7 como Estratégia de Chave Primária
...
- [ADR-0006](./0006-adocao-do-postgresql-como-banco-de-dados.md): PostgreSQL como banco que armazenará as chaves UUID v7
- [ADR-0020](./0020-convencoes-de-escrita-de-migracoes.md): convenções de migrações que definem como a coluna de PK UUID é declarada
