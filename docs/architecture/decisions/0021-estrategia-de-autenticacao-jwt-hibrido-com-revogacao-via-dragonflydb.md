# [ADR-0021]: Estratégia de Autenticação: JWT Híbrido com Revogação via DragonflyDB
...
O ADR-0005 adota o DragonflyDB para cache, rate limiting e broker de filas. A blocklist de `jti`s e os contadores de `auth_version` são mais dois usos do mesmo serviço — sem nova dependência, sem nova peça de infraestrutura para operar.
...
- [ADR-0019 — Adoção de UUID v7 como Estratégia de Chave Primária](./0019-adocao-de-uuid-v7-como-estrategia-de-chave-primaria.md)
