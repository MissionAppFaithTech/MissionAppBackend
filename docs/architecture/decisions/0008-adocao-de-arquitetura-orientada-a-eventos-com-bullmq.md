...
- [ADR-0003](./0003-adocao-do-redis-como-cache-e-armazenamento-temporario.md): DragonflyDB como broker de filas onde os jobs BullMQ são persistidos
- [ADR-0005](./0005-adocao-do-elasticsearch-como-mecanismo-de-busca.md): Elasticsearch como destino de jobs de indexação processados pelos workers
