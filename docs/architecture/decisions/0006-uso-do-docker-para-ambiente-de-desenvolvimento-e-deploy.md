...
- [ADR-0003](./0003-adocao-do-redis-como-cache-e-armazenamento-temporario.md): DragonflyDB como cache e broker, um dos serviços orquestrados pelo Docker Compose
- [ADR-0004](./0004-uso-do-minio-como-emulador-de-storage-em-desenvolvimento.md): MinIO como emulador de storage, um dos serviços orquestrados pelo Docker Compose
- [ADR-0005](./0005-adocao-do-elasticsearch-como-mecanismo-de-busca.md): Elasticsearch como mecanismo de busca, um dos serviços orquestrados pelo Docker Compose
