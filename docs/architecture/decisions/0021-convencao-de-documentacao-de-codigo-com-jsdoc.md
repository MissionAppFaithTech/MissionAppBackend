# [ADR-0021]: Convenção de Documentação de Código com JSDoc
...
- [ADR-0020](./0020-estrategia-de-autenticacao-jwt-hibrido-com-revogacao-via-dragonflydb.md): invariantes de segurança do fluxo de autenticação — exemplo central de comportamento que justifica JSDoc
