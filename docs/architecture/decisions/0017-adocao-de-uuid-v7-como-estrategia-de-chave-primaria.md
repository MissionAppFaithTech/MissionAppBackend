...
- [ADR-0002](./0002-adocao-do-postgresql-como-banco-de-dados.md): PostgreSQL como banco que armazenará as chaves UUID v7
- [ADR-0016](./0016-convencoes-de-escrita-de-migracoes.md): convenções de migrações que definem como a coluna de PK UUID é declarada
