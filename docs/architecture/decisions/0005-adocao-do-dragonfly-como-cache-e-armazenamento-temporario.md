# [ADR-0005]: Adoção do DragonflyDB como Cache, Armazenamento Temporário e Broker de Filas
...
- [ADR-0004](./0004-adocao-do-postgresql-como-banco-de-dados.md): adoção do PostgreSQL, contexto da stack de persistência
