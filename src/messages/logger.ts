...
export const PASSWORD_RESET_EMAIL_FAILED =
	"Falha ao enviar e-mail de redefinição de senha";
export const DELETE_FAILURE = "Falha ao deletar";
export const DAILY_TEMP_IMAGES_CLEANUP =
	"Executando limpeza diária de imagens de perfil obsoletas";
export const LISTING_FILES_ERROR = "Erro ao listar arquivos";
export const FILE_LIFETIME_CALCULATION_ERROR =
...
export const PROFILE_IMAGE_PERSIST_ERROR =
	"Erro durante a persistência da imagem de perfil do usuário";
