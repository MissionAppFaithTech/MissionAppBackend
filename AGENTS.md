...
| Authentication        | ADR-0020 (JWT hybrid + DragonflyDB revocation)                      |
| JSDoc convention      | ADR-0021 (selective, why-focused documentation)                     |
| Controller & routing  | ADR-0022 (5 standard methods, dedicated controllers, nesting rules) |
| Query filters         | ADR-0023 (adonis-lucid-filter, filter class per model)              |
| API documentation     | ADR-0024 (OpenAPI static YAML + Scalar)                             |
